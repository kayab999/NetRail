...
```bash
git clone git@github.com:netrail/netrail.git NetRail && cd NetRail
...
Download the AppImage or `.deb` from the [Releases](https://github.com/netrail/netrail/releases) page. Verify checksums against `SHA256SUMS` in the release assets.
