...
- **Host allowlist:** `Host` must be loopback (`127.0.0.1:7421` / `localhost:7421`); otherwise `HOST_INVALID` 403 before auth.
- **Azure IMDS:** `168.63.129.16` blocked at open-URL and backend-URL policy (golden fixture vectors).
